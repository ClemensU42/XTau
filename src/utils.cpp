...
template<typename T>
std::string XTau::Size<T>::ToString() const {
...
template<typename T>
std::string XTau::Position<T>::ToString() const{
    std::ostringstream out;
    out << "(" << x << ", " << y << ")";
    return out.str();
}
...
template<typename T>
std::string XTau::Vector2D<T>::ToString() const{
    std::ostringstream out;
    out << "(" << x << ", " << y << ")";
    return out.str();
}
...
std::string XTau::Join(const Container& container, const std::string& delimiter){
    std::ostringstream out;
...
std::string XTau::Join(const Container& container, const std::string& delimiter, Converter converter){
...
template<typename T>
std::string XTau::ToString(const T& x){
    std::ostringstream out;
    out << x;
    return out.str();
}

std::string XTau::XRequestCodeToString(uint8_t request_code)
{
...
std::string XTau::XConfigureWindowValueMaskToString(unsigned long value_mask)
{
...
std::string XTau::ToString(const XEvent &e)
{
